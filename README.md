...
Она сначала удаляет прежний готовый набор, выполняет release-сборку и закрытый аудит, а затем создаёт `app/build/outputs/release-ready/` с четырьмя APK, standalone-архивом того же серверного бинарника, его внешней контрольной суммой и отдельным архивом WARP-менеджера. Если сервер внутри хотя бы одного APK, standalone-архива или текущих исходников отличается либо архив WARP не прошёл проверку, готовый каталог не создаётся.
