...
- **Автообновления:** приложение проверяет релизы WDTT Plus при запуске и каждые 30 минут, если остаётся открытым, скачивает подходящий APK внутри приложения и передаёт его системному установщику Android. Если APK текущей версии был заменён в релизе, WDTT Plus сверяет SHA-256 установленного APK со всеми APK релиза и предлагает исправление текущей версии.
